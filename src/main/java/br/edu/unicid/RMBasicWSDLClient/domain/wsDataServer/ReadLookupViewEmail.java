 ...
 *         &lt;element name="OwnerData" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "ReadLookupViewEmail")
public class ReadLookupViewEmail {
    ...
    @XmlElementRef(name = "OwnerData", namespace = "http://www.totvs.com/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ownerData;
    ...
    /**
     * Obtém o valor da propriedade ownerData.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getOwnerData() {
        return ownerData;
    }

    /**
     * Define o valor da propriedade ownerData.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setOwnerData(JAXBElement<String> value) {
