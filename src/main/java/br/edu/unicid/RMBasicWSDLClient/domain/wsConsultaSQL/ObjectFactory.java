...
public class ObjectFactory {
    ...
    private final static QName _RealizarConsultaSQLCodSentenca_QNAME = new QName("http://www.totvs.com/", "codSentenca");
    private final static QName _RealizarConsultaSQLCodSistema_QNAME = new QName("http://www.totvs.com/", "codSistema");
    private final static QName _RealizarConsultaSQLParameters_QNAME = new QName("http://www.totvs.com/", "parameters");
    ...
    /**
     * Create an instance of {@link RealizarConsultaSQL }
     * 
     */
    public RealizarConsultaSQL createRealizarConsultaSQL() {
        return new RealizarConsultaSQL();
    }

    /**
     * Create an instance of {@link RealizarConsultaSQLResponse }
     * 
     */
    public RealizarConsultaSQLResponse createRealizarConsultaSQLResponse() {
        return new RealizarConsultaSQLResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.totvs.com/", name = "codSentenca", scope = RealizarConsultaSQL.class)
    public JAXBElement<String> createRealizarConsultaSQLCodSentenca(String value) {
        return new JAXBElement<String>(_RealizarConsultaSQLCodSentenca_QNAME, String.class, RealizarConsultaSQL.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.totvs.com/", name = "codSistema", scope = RealizarConsultaSQL.class)
    public JAXBElement<String> createRealizarConsultaSQLCodSistema(String value) {
        return new JAXBElement<String>(_RealizarConsultaSQLCodSistema_QNAME, String.class, RealizarConsultaSQL.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.totvs.com/", name = "parameters", scope = RealizarConsultaSQL.class)
    public JAXBElement<String> createRealizarConsultaSQLParameters(String value) {
        return new JAXBElement<String>(_RealizarConsultaSQLParameters_QNAME, String.class, RealizarConsultaSQL.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.totvs.com/", name = "RealizarConsultaSQLResult", scope = RealizarConsultaSQLResponse.class)
    public JAXBElement<String> createRealizarConsultaSQLResponseRealizarConsultaSQLResult(String value) {
        return new JAXBElement<String>(_RealizarConsultaSQLResponseRealizarConsultaSQLResult_QNAME, String.class, RealizarConsultaSQLResponse.class, value);
    }
